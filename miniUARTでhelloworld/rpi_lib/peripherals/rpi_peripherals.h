...
// mini UART
#define miniUART_BASE	(0x00215000)
#define AUX_ENABLE	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x04))
#define AUX_MU_IO	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x40))
#define AUX_MU_IER	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x44))
#define AUX_MU_IIR	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x48))
#define AUX_MU_LCR	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x4C))
#define AUX_MU_MCR	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x50))
#define AUX_MU_LSR	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x54))
#define AUX_MU_MSR	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x58))
#define AUX_MU_SCRATCH	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x5C))
#define AUX_MU_CNTL	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x60))
#define AUX_MU_STAT	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x64))
#define AUX_MU_BAUD	((vu32_t *)PHY_PERI_ADDR(GPIO_BASE + 0x68))
